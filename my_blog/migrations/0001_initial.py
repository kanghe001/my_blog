    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default=b'avatar', upload_to=b'avatar/%Y/%m')),
                ('qq', models.CharField(max_length=20, verbose_name=b'QQ', blank=True)),
                ('mobile', models.CharField(max_length=11, null=True, verbose_name=b'\xe7\x94\xb5\xe8\xaf\x9d\xe5\x8f\xb7\xe7\xa0\x81', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=999, verbose_name=b'\xe6\x8e\x92\xe5\xba\x8f\xe9\xa1\xba\xe5\xba\x8f\xef\xbc\x88\xe4\xbb\x8e\xe5\xb0\x8f\xe5\x88\xb0\xe5\xa4\xa7\xef\xbc\x89')),
            ],
            options={
                'ordering': ['index', 'id'],
                'verbose_name': '\u5e7f\u544a',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_publish', models.DateTimeField(auto_now_add=True, verbose_name=b'\xe5\x8f\x91\xe5\xb8\x83\xe6\x97\xb6\xe9\x97\xb4')),
                ('pid', models.ForeignKey(verbose_name=b'\xe7\x88\xb6\xe7\xba\xa7\xe8\xaf\x84\xe8\xae\xba', blank=True, to='my_blog.Comment', null=True)),
                ('user', models.ForeignKey(verbose_name=b'\xe6\x96\x87\xe7\xab\xa0', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ['-date_publish'],
                'verbose_name': '\u8bc4\u8bba',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('callback_url', models.DateTimeField(verbose_name=b'URL\xe5\x9c\xb0\xe5\x9d\x80')),
                ('date_publish', models.DateTimeField(auto_now_add=True, verbose_name=b'\xe5\x8f\x91\xe5\xb8\x83\xe6\x97\xb6\xe9\x97\xb4')),
                ('index', models.IntegerField(default=999, verbose_name=b'\xe6\x8e\x92\xe5\xba\x8f\xe9\xa1\xba\xe5\xba\x8f\xef\xbc\x88\xe4\xbb\x8e\xe5\xb0\x8f\xe5\x88\xb0\xe5\xa4\xa7\xef\xbc\x89')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='artical',
            name='category',
            field=models.ForeignKey(verbose_name=b'\xe5\x88\x86\xe7\xb1\xbb', to='my_blog.Category'),
        ),
        migrations.AddField(
            model_name='artical',
            name='tag',
            field=models.ManyToManyField(to='my_blog.Tag', verbose_name=b'\xe6\xa0\x87\xe7\xad\xbe'),
        ),
        migrations.AddField(
            model_name='artical',
            name='user',
